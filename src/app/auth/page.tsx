      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">
            {isSignUp ? 'Join' : 'Welcome to'} Electric
          </h2>
          <p className="text-gray-600">
            {isSignUp ? 'Create your account to get started' : 'Philippine Business CRM Platform'}
          </p>
        </div>
        ...
        {/* Auth Form */}
        <div className="bg-white shadow-2xl rounded-2xl px-8 py-8">
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    required
                    className="appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="appearance-none relative block w-full px-4 py-3 pr-12 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent focus:z-10 sm:text-sm"
